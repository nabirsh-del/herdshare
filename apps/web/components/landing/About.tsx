    ...
    <section id="about" className="py-24 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div ref={featuresRef} className="reveal" style={{ transitionDelay: '100ms' }}>
            <div className="grid grid-cols-2 gap-8">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Locked Pricing</p>
                <p className="text-sm text-gray-500">Flat rate, all cuts</p>
              </div>
              <div>
